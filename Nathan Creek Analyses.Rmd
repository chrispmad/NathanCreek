...
old_ave |> 
  ...
  labs(y = 'Percent Mean Annual Discharge',
       x = '') + 
...
change_in_ave |> 
  ...
  ggplot(aes(x = my_date)) + 
  # geom_point(aes(y = percent_change, col = change_type)) +
  geom_line(aes(y = nathan_predicted), col = 'black') +
  geom_line(aes(y = 1), lty = 2, col = 'darkgrey') + 
  ...
  labs(y = 'Predicted % Mean Annual Discharge',
       x = '',
       title = 'Predicted Nathan Creek flow vs. ground-truthed flow data (red dot)',
